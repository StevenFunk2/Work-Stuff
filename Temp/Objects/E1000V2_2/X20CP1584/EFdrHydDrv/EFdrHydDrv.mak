...
$(AS_CPU_PATH)/EFdrHydDrv/Cyclic.ld.o: \
	...
	FORCE 
	@"$(AS_BIN_PATH)/BR.AS.IecCompiler.exe" "$(AS_PROJECT_PATH)/Logical/EFdrHydDrv1/Cyclic.ld" -o "$(AS_CPU_PATH)/EFdrHydDrv/Cyclic.ld.o"  -O "$(AS_CPU_PATH)//EFdrHydDrv/Cyclic.ld.o.opt" -secret "$(AS_PROJECT_PATH)_br.as.ieccompiler.exe"

$(AS_CPU_PATH)/EFdrHydDrv/Init.ld.o: \
	$(AS_PROJECT_PATH)/Logical/EFdrHydDrv1/Init.ld \
	FORCE 
	@"$(AS_BIN_PATH)/BR.AS.IecCompiler.exe" "$(AS_PROJECT_PATH)/Logical/EFdrHydDrv1/Init.ld" -o "$(AS_CPU_PATH)/EFdrHydDrv/Init.ld.o"  -O "$(AS_CPU_PATH)//EFdrHydDrv/Init.ld.o.opt" -secret "$(AS_PROJECT_PATH)_br.as.ieccompiler.exe"

$(AS_CPU_PATH)/EFdrHydDrv/Exit.ld.o: \
	$(AS_PROJECT_PATH)/Logical/EFdrHydDrv1/Exit.ld \
	FORCE 
	@"$(AS_BIN_PATH)/BR.AS.IecCompiler.exe" "$(AS_PROJECT_PATH)/Logical/EFdrHydDrv1/Exit.ld" -o "$(AS_CPU_PATH)/EFdrHydDrv/Exit.ld.o"  -O "$(AS_CPU_PATH)//EFdrHydDrv/Exit.ld.o.opt" -secret "$(AS_PROJECT_PATH)_br.as.ieccompiler.exe"
