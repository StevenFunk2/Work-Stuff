SHELL = cmd.exe
CYGWIN=nontsec
export PATH := C:\Program Files (x86)\Rockwell Software\RSCommon\;C:\Program Files (x86)\Common Files\Rockwell;C:\Program Files (x86)\Rockwell Software\RSCommon;C:\WINDOWS\system32;C:\WINDOWS;C:\WINDOWS\System32\Wbem;C:\WINDOWS\System32\WindowsPowerShell\v1.0\;C:\Program Files (x86)\Windows Kits\8.1\Windows Performance Toolkit\;C:\Program Files\Microsoft SQL Server\110\Tools\Binn\;C:\Program Files (x86)\Common Files\Rockwell\;c:\Program Files (x86)\Microsoft SQL Server\100\Tools\Binn\;c:\Program Files (x86)\Microsoft SQL Server\100\DTS\Binn\;C:\Program Files (x86)\Rockwell Software\RSView Enterprise\;C:\Program Files (x86)\Rockwell Automation\Common\Components;c:\Program Files (x86)\Microsoft SQL Server\90\Tools\binn\;C:\Users\io_sfunk\AppData\Local\Microsoft\WindowsApps;C:\Program Files (x86)\Common Files\Hilscher GmbH\TLRDecode;C:\Users\io_sfunk\AppData\Local\Microsoft\WindowsApps;C:\Program Files (x86)\Common Files\Hilscher GmbH\TLRDecode
...
export AS_CONFIGURATION := E1000V2_1
